...
// The UwbDevice, UwbRangingData, and UwbPlugin types are assumed to be
// defined elsewhere in the project, likely in a file generated by Pigeon.
...
class NISessionManager: NSObject, NISessionDelegate {
    ...
    func startRanging(with peerTokenData: Data, isAccessory: Bool) throws {
        ...
        if isAccessory {
            ...
            tokenForSessionKey = accessoryConfiguration.accessoryDiscoveryToken
        } else {
            ...
            tokenForSessionKey = peerConfiguration.peerDiscoveryToken
        }
